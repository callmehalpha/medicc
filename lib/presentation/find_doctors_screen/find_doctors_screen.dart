...
import '../find_doctors_screen/widgets/gridsettings_item_widget.dart';
                  ...
                  Align(
                    ...
                    child: Padding(
                      ...
                      child: Text(
                        ...
                        overflow: TextOverflow.ellipsis,
                        textAlign: TextAlign.left,
                        style: AppStyle.txtInterSemiBold18Gray905.copyWith(
                          letterSpacing: 0.30,
                        ),
                      ),
                    ),
                      ...
                      child: Obx(
                        () => GridView.builder(
                          ...
                          itemCount: controller.findDoctorsModelObj.value
                              .gridsettingsItemList.length,
                          itemBuilder: (context, index) {
                            GridsettingsItemModel model = controller
                                .findDoctorsModelObj
                                .value
                                .gridsettingsItemList[index];
                            return GridsettingsItemWidget(
                              model,
                            );
                          },
                        ),
                  ...
                  Align(
                    ...
                    child: Padding(
                      ...
                      child: Text(
                        ...
                        textAlign: TextAlign.left,
                        style:
                            AppStyle.txtRalewayRomanSemiBold18Gray905.copyWith(
                          letterSpacing: 0.30,
                        ),
                      ),
                    ),
                              ...
                              children: [
                                ...
                                Padding(
                                  ...
                                  child: Text(
                                    ...
                                    textAlign: TextAlign.left,
                                    style: AppStyle
                                        .txtRalewayRomanRegular14Gray500
                                        .copyWith(),
                                  ),
                                ),
                                Container(
                                    ...
                                    children: [
                                      ...
                                      Padding(
                                        ...
                                        child: Text(
                                          ...
                                          textAlign: TextAlign.left,
                                          style: AppStyle
                                              .txtRalewayRomanMedium12Amber500
                                              .copyWith(),
                                        ),
                                      ),
                                      Padding(
                                        ...
                                        child: CommonImageView(
                                          svgPath:
                                              ImageConstant.imgLocation13X11,
                                          height: getVerticalSize(
                                            13.00,
                                          ),
                                          width: getHorizontalSize(
                                      ...
                                      Padding(
                                        ...
                                        child: Text(
                                          ...
                                          textAlign: TextAlign.left,
                                          style: AppStyle
                                              .txtRalewayRomanMedium14Bluegray800
                                              .copyWith(),
                                        ),
                                      ),
                                    ],
                  ...
                  Align(
                    ...
                    child: Padding(
                      ...
                      child: Text(
                        ...
                        overflow: TextOverflow.ellipsis,
                        textAlign: TextAlign.left,
                        style: AppStyle.txtRalewayRomanSemiBold18Gray905
                            .copyWith(),
                      ),
                    ),
                  ),
