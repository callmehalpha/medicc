...
class ListdrmarcushoriItemWidget extends StatelessWidget {
  ListdrmarcushoriItemWidget(this.listdrmarcushoriItemModelObj);

  ListdrmarcushoriItemModel listdrmarcushoriItemModelObj;
