...
class ListhealthvitllysItemWidget extends StatelessWidget {
  ListhealthvitllysItemWidget(this.listhealthvitllysItemModelObj,
      {this.onTapImgPlus});

  ListhealthvitllysItemModel listhealthvitllysItemModelObj;
